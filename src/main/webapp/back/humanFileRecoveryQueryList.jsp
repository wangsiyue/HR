...
<body>
	<p class="p1">您正在做的业务是：人力资源--人力资源档案管理--人力资源档案恢复管理--人力资源档案查询</p>
...
function get(){
	...
	$('#find_humanFile').datagrid({
		url:'../findRecoveryByConditionAndPage.action',
		queryParams:{
		...
		columns:[[
					...
					{field:'cz',title:'操作',width:115,formatter:function(value,row,index){
						return '<a href="../recoveryHumanFile.action?human_id='+row.human_id+'">恢复</a>';
					}}
		]]
	});
}
