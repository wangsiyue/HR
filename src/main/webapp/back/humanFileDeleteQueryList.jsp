...
<body>
	<p class="p1">您正在做的业务是：人力资源--人力资源档案管理--人力资源档案删除管理--人力资源档案查询</p>
...
function get(){
	...
	$('#find_humanFile').datagrid({
		url:'../findDelByConditionAndPage.action',
		queryParams:{
		...
		columns:[[
					...
					{field:'cz',title:'操作',width:115,formatter:function(value,row,index){
						return '<a href="../delHumanFile.action?human_id='+row.human_id+'">删除</a>';
					}}
		]]
	});
}
