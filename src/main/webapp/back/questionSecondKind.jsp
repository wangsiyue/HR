...
<body>
	<form method="post" action="toQuestionSecondKindRegister.action">
		...
		<div style="position: relative; left: 1030px;">
		 ...
		 <table border="1" width="1000" align="center" bgcolor="#E0ECFF">
			<tr>
				...
				<td width="20%" class="t1">试题二级分类编号</td>
				<td width="20%" class="t1">试题二级分类名称</td>
			...
			<c:forEach items="${list}" var="list">
				<tr>
					...
					<td align="center"><a href="tochangeQuestionSecondKind.action?qsk_id=${list.qsk_id}">变更</a></td>
					<td align="center"><a href="DelQuestionSecondKind.action?qsk_id=${list.qsk_id}">删除</a></td>
				</tr>
			</c:forEach>
		</table>
	</form>
