...
<p>您正在做的业务是：人力资源--招聘管理--录用管理--录用申请</p>
    <form id="form" method="post" >
		<div style="position: relative; left: 750px;">
			<input name="result" type="radio" value="释放简历 "/>释放简历 
            <input name="result" type="radio" value="申请录用" />申请录用
			<input type="button" value="确认" onclick="reg();"/>
