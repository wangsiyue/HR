...
function check(){
	...
	var check_comment=$('#check_comment').val();
	var res_id=$('#res_id').val();
	$.post('interviewCheck.action',{
		result:result,
		ein_id:ein_id,
		checker:checker,
        ...
        <table border="1" width="1000" align="center" bgcolor="#E0ECFF">
           ...
           <tr>
            ...
            <tr>  
                ...
                <td class="t1">筛选人</td>
                <td><input id="checker" value="<% 
					Users user=(Users)session.getAttribute("user");
					out.print(user.getU_true_name()); 
				%>"/></td>
                <td class="t1">筛选时间</td>
                <td><input id="check_time" class="easyui-datebox" value="${date}"/></td>
            </tr>
            <tr>
				<td class="t1"> 录用申请审核意见 </td>
				<td colspan="7"><textarea id="check_comment"></textarea></td>
			</tr>
        </table>
    </form>
</body>
