		...
		$(".submit").click(function() {
			$("#form").ajaxSubmit({
				success : function(data) {
					if (data == 1) {
						window.location.href='back/humanFileChangeSuccess.jsp';
					} else {
						window.location.href='back/humanFileChangeFailure.jsp';
					}
				},
				error : function(error) {
					window.location.href='back/humanFileChangeFailure.jsp';
				},
				url : 'changeHumanFile.action',// 设置post提交到的页面
...
<body>
	...
	<form id="form" method="post" >
		...
		<input name="human_id" id="human_id" type="hidden" value="${humanFile.human_id}"/>
		...
		<input name="file_chang_amount" id="file_chang_amount" type="hidden" value="${humanFile.file_chang_amount}" /> 
		<table border="1" width="1000" align="center" bgcolor="#E0ECFF">
			<tr>
            	<td class="t1">档案编号</td>
                <td colspan="6">${humanFile.human_id}</td>
                <td rowspan="6" >
			...
			<tr>
				...
				<td>${humanFile.second_kind_name}
				</td>
				<td class="t1">III级机构</td>
				<td colspan="2">${humanFile.third_kind_name}
				</td>
			</tr>
			<tr>
				<td class="t1">职位分类</td>
				<td>${humanFile.human_major_kind_name}
				</td>
				<td class="t1">职位名称</td>
				<td>${humanFile.hunma_major_name}
				</td>
				<td class="t1">职称</td>
				<td colspan="2">
			...
			<tr>
				...
				<td class="t1">变更人</td>
				<td><input class="easyui-validatebox" name="changer" id="changer"
					value="<% 
