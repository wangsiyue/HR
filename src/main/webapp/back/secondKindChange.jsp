...
<body>
	<form:form commandName="configFileSecondKind"
		action="changeConfigFileSecondkind.action" method="post">
		<p class="p1">您正在做的业务是：人力资源--客户化设置--人力资源档案管理设置--I级机构设置</p>
		<div style="position: relative; left: 1030px;">
			<input type="submit" value="提交" >
			<input type="button" value="返回" onclick="history.back();">
		</div>
		<form:hidden path="fsk_id" value="${fsk_id}"/>
		<table border="1" width="1000" align="center" bgcolor="#E0ECFF">
			<tr>
				<td width="19%" class="t1">I级机构编号</td>
				<td width="81%"><form:input path="first_kind_id" value="${first_kind_id }"/></td>
			</tr>
			<tr>
				<td class="t1">I级机构名称</td>
				<td><form:input path="first_kind_name" value="${first_kind_name }"/></td>
			</tr>
			<tr>
				<td width="19%" class="t1">II级机构编号</td>
				<td width="81%"><form:input path="second_kind_id" value="${second_kind_id }"/></td>
			</tr>
			<tr>
				<td class="t1">II级机构名称</td>
				<td><form:input path="second_kind_name" value="${second_kind_name }"/></td>
			</tr>
			<tr>
