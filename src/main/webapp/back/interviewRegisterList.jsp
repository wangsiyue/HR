...
<script type="text/javascript">
	$('#dg').datagrid({
		url:'showInterviewRegistList.action',
		pagination:true,
		pageSize:2,
		pageList:[2,3,4,5,6],
		columns:[[
				{field:'human_name',align:'center',title:'姓名',width:130},
		        {field:'human_sex',align:'center',title:'性别',width:130},
		        ...
		        {field:'human_college',title:'毕业院校',width:130},
		     	 {field:'human_educated_major',title:'学历专业',width:130},
     	  		{field:'cz',title:'操作',width:125,formatter:function(value,row,index){
					return '<a href="toInterviewRegister.action?res_id='+row.res_id+'">登记</a>';
				}}
		]]
	});
</script>
