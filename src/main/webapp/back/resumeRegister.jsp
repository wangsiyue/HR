...
<p>您正在做的业务是：人力资源--招聘管理--简历管理--简历登记</p>
    <form id="form" method="post" >
		...
		<input name="human_major_id" id="human_major_id" type="hidden" value="${engageMajorRelease.major_id}"/>
		<input name="human_major_kind_id" id="human_major_kind_id" type="hidden" value="${engageMajorRelease.major_kind_id}" /> 
        <table border="1" width="1000" align="center" bgcolor="#E0ECFF">
            <tr>
            	<td class="t1">职位分类</td>
                <td><input type="text" name="human_major_kind_name" value="${engageMajorRelease.major_kind_name }"/></td>
                <td class="t1">职位名称</td>
                <td><input type="text" name="human_major_name" value="${engageMajorRelease.major_name }"/></td>
                <td class="t1">招聘类型</td>
                <td colspan="2"><input name="engage_type" type="text" value="${engageMajorRelease.engage_type }"/></td>
            ...
            <tr>
                ...
                <td><input name="human_idcard" id="human_idcard"/></td>
            	<td class="t1">年龄</td>
