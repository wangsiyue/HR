...
<body>
	<form:form commandName="configFileFirstKind" action="addConfigfilefirstkind.action" method="post">
		...
		<table border="1" width="1000" align="center" bgcolor="#E0ECFF">
			...
			<tr>
				...
				<td><form:textarea path="first_kind_salary_id"></form:textarea></td>
			</tr>
			<tr>
				<td class="t1">销售责任人编号（多个编号之间请用"半角逗号"加"一个空格"隔开，如", "）</td>
				<td><form:textarea path="first_kind_sale_id"></form:textarea></td>
			</tr>
		</table>
	</form:form>
</body>
