...
<body>
	<table width="100%">
		...
		<tr>
			<td width="49%">您确认删除 <label>${configMajorKind.major_kind_id }</label>
				/ <label>${configMajorKind.major_kind_name }</label> 这条记录吗?
			</td>
			<td width="51%" align="right"><input type="button" value="删除"
				class="BUTTON_STYLE1"
				onclick="del('${configMajorKind.mfk_id }');"> <input
